...
class CustomDeepResRNN_4(nn.Module):
  def __init__(self, vocab_size, num_classes=3):
    super(CustomDeepResRNN_4, self).__init__()
...
if __name__ == "__main__":
  MODEL_NAME = "custom_deep_res_rnn_4"
  ...
  model = CustomDeepResRNN_4(vocab_size=VOCAB_SIZE, num_classes=OUTPUT_DIM)
